# ============================================================
#  Boter 訂單管理系統 — 自動 Git Push 監視腳本
#  監視 index.html / manual.html，變更後自動 commit + push
# ============================================================
...
$timerAction = {
    ...
    # git add all html files
    & git add "*.html" 2>&1 | Out-Null
    ...
    # git commit
    $msg = "auto: update boter-orders $(Get-Date -Format 'MM/dd HH:mm')"
